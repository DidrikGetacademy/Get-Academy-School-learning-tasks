...
function Trainfighterarena(Trainer){
    if(Trainer === 'trainer0'){
...
if(Trainer === 'trainer0'){
    html += /*HTML*/ `
    <button onclick="kampArenaView(${selected})">Go back</button>
    <div>
    ...
    <div class="healthBox2">Health: ${model.pokemons[i,selected].health}</div>
    ...
    <div class="healthBox1"> Health: ${model.pokemons[0].health}</div>
    <button onclick="Trainfighterarena(${selected}, 'trainerPokedex2')" class="trainerfighterbutton1">Attack2</button>
    </div>
    </div>`;
    ...
    <div class="healthBox1">Health: ${model.pokemons[1].health}</div>
    ...
    <div class="healthBox1">Health: ${model.pokemons[2].health}</div>
    <button class="trainerfighterbutton1" onclick="Trainfighterarena(${selected},'trainerPokedex5')">Attack1</button>  
    </div>`;
